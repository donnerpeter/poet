...
-- German:
solvedShapes = [[WordShape {wsTotal = 2, wsAccent = 2},WordShape {wsTotal = 2, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 1, wsAccent = 1},WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0}],[],[WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 2, wsAccent = 2}],[WordShape {wsTotal = 1, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 1, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 3, wsAccent = 3}],[WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 1, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 5, wsAccent = 3},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 1, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 5, wsAccent = 3},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 2, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 4, wsAccent = 4},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 5, wsAccent = 3},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 2, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 3},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 5, wsAccent = 3},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 1, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 5, wsAccent = 3},WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 1, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 5, wsAccent = 3},WordShape {wsTotal = 4, wsAccent = 2}],[WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 4, wsAccent = 2}],[WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 4, wsAccent = 2}],[WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 4, wsAccent = 4},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 3},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 2, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 1, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 4, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 2, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 2, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 1, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 1, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}],[WordShape {wsTotal = 2, wsAccent = 2},WordShape {wsTotal = 1, wsAccent = 0},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 2, wsAccent = 1},WordShape {wsTotal = 3, wsAccent = 1},WordShape {wsTotal = 1, wsAccent = 0}]]
----------------------
...
templateMarkups = zipWith limitWordCount (map (\lineTemplate -> (M.!) cache (query lineTemplate)) template) [0..] where
  limitWordCount markups lineIndex = filter (\shapes -> if lineIndex >= lineCount - 2 then elemCount shapes > 4 else elemCount shapes < 6) markups where
    elemCount shapes = length $ filter (/= fillerShape) shapes
  lineCount = length template
...
template1 = take (length templateVectors `div` 2) templateVectors
template2 = drop (length templateVectors `div` 2) templateVectors
target1 = listToVector $ map (`div` 2) $ vecBytes maxVector
